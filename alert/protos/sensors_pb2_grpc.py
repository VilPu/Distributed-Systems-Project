...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in protos/sensors_pb2_grpc.py depends on'
...
class SensorManagerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSensorData = channel.unary_unary(
                ...
                request_serializer=protos_dot_sensors__pb2.SensorRequest.SerializeToString,
                response_deserializer=protos_dot_sensors__pb2.SensorReading.FromString,
                _registered_method=True)
        self.ListSensors = channel.unary_unary(
                '/sensors.SensorManager/ListSensors',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=protos_dot_sensors__pb2.SensorsList.FromString,
                _registered_method=True)
        self.PushReading = channel.unary_unary(
                '/sensors.SensorManager/PushReading',
                request_serializer=protos_dot_sensors__pb2.SensorReading.SerializeToString,
                response_deserializer=protos_dot_sensors__pb2.Response.FromString,
                _registered_method=True)
...
def add_SensorManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSensorData': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_sensors__pb2.SensorRequest.FromString,
                    response_serializer=protos_dot_sensors__pb2.SensorReading.SerializeToString,
            ),
            'ListSensors': grpc.unary_unary_rpc_method_handler(
                    servicer.ListSensors,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=protos_dot_sensors__pb2.SensorsList.SerializeToString,
            ),
            'PushReading': grpc.unary_unary_rpc_method_handler(
                    servicer.PushReading,
                    request_deserializer=protos_dot_sensors__pb2.SensorReading.FromString,
                    response_serializer=protos_dot_sensors__pb2.Response.SerializeToString,
            ),
    }
...
class SensorManager(object):
    ...
    def GetSensorData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/sensors.SensorManager/GetSensorData',
            protos_dot_sensors__pb2.SensorRequest.SerializeToString,
            protos_dot_sensors__pb2.SensorReading.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ListSensors(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            protos_dot_sensors__pb2.SensorsList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def PushReading(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/sensors.SensorManager/PushReading',
            protos_dot_sensors__pb2.SensorReading.SerializeToString,
            protos_dot_sensors__pb2.Response.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class StorageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetHistory = channel.unary_unary(
                ...
                request_serializer=protos_dot_sensors__pb2.SensorRequest.SerializeToString,
                response_deserializer=protos_dot_sensors__pb2.SensorHistory.FromString,
                _registered_method=True)
...
def add_StorageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetHistory': grpc.unary_unary_rpc_method_handler(
                    servicer.GetHistory,
                    request_deserializer=protos_dot_sensors__pb2.SensorRequest.FromString,
                    response_serializer=protos_dot_sensors__pb2.SensorHistory.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class StorageService(object):
    ...
    def GetHistory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/sensors.StorageService/GetHistory',
            protos_dot_sensors__pb2.SensorRequest.SerializeToString,
            protos_dot_sensors__pb2.SensorHistory.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class AlertServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CheckAlert = channel.unary_unary(
                ...
                request_serializer=protos_dot_sensors__pb2.SensorReading.SerializeToString,
                response_deserializer=protos_dot_sensors__pb2.AlertStatus.FromString,
                _registered_method=True)
        self.GetAlerts = channel.unary_unary(
                '/sensors.AlertService/GetAlerts',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=protos_dot_sensors__pb2.AlertList.FromString,
                _registered_method=True)
...
def add_AlertServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CheckAlert': grpc.unary_unary_rpc_method_handler(
                    servicer.CheckAlert,
                    request_deserializer=protos_dot_sensors__pb2.SensorReading.FromString,
                    response_serializer=protos_dot_sensors__pb2.AlertStatus.SerializeToString,
            ),
            'GetAlerts': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAlerts,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=protos_dot_sensors__pb2.AlertList.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class AlertService(object):
    ...
    def CheckAlert(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/sensors.AlertService/CheckAlert',
            protos_dot_sensors__pb2.SensorReading.SerializeToString,
            protos_dot_sensors__pb2.AlertStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetAlerts(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/sensors.AlertService/GetAlerts',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            protos_dot_sensors__pb2.AlertList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
